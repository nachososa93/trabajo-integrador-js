...
const contactonav = document.getElementById("contactonav")
...
const passwordInputRepeat = document.querySelector( ".contraseña__input__repeat");
...
const contenidoCartelAlertLogin = document.querySelector(".contenido__cartel__alert__register");
